...
### Application
* Javascript [Electron-wrapped](https://www.electronjs.org/) click and play executable is [available here](https://github.com/WU-BIMAC/MicroMetaApp-Electron/releases/tag/0.44.0-b1-0) 
